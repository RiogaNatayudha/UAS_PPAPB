...
import com.example.ppapb.databinding.AdminUpdateBinding
...
class UpdateAdmin : AppCompatActivity() {
    private lateinit var binding: AdminUpdateBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = AdminUpdateBinding.inflate(layoutInflater)
        setContentView(binding.root)

        binding.adminListUpdateImageUrl.setOnClickListener{
            getContent.launch("image/*")
        }

        val title = binding.adminListUpdateJudul
        val author = binding.adminListUpdatePembuatDanRating
    ...
    private fun uploadData(imageUri: Uri? = null) {
        val updatedTitle = binding.adminListUpdateJudul.text.toString()
        val updatedAuthor = binding.adminListUpdatePembuatDanRating.text.toString()
        val updatedDescription = binding.adminListUpdateDescription.text.toString()
        val updatedGenre = binding.adminListUpdateGenre.text.toString()
        val updatedStoryline = binding.adminListUpdateStoryline.text.toString()
